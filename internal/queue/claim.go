...
// ─── Claim ────────────────────────────────────────────────────
//
// platform node-api เติม prewarm_queue เป็น pending — worker claim
...
// ErrJobRetry marks a transient content-origin failure. Unlike config
// requeues, this increments retryCount so the worker can stop after a bounded
